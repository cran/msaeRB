#' @title Sample Data for Multivariate Non Sampled Area in Small Area Estimation with Ratio Benchmarking
#'
#' @description Dataset to simulate ratio benchmarking of Multivariate non sampled area in Fay-Herriot model
#'
...
#' }
#'
#' @format A data frame with 30 rows and 17 variables:
#' \describe{
